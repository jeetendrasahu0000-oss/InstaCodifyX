...
function MiniOTP({ onComplete, loading }) {
  ...
  return (
    <div className={styles.miniOtpWrap}>
      <div className={styles.miniOtpLabel}>
        <IconShield /> Enter 6-digit code sent to your email
      </div>
...
export default function Forgot() {
  ...
  const [resetToken,      setResetToken]      = useState('')  // backend returns temp token after OTP verify
  ...
  const handleEmailChange = (e) => {
    ...
    if (otpSent || otpVerified) {
      setOtpSent(false); setOtpVerified(false); setSuccess('')
    }
  }
      ...
      <div className={styles.card}>
        ...
        <div className={styles.header}>
          <h2 className={styles.title}>
            {otpVerified ? 'New Password' : 'Forgot Password?'}
          </h2>
          ...
          <form className={styles.form} onSubmit={handleResetPassword} noValidate>
            ...
            <div className={styles.field}>
              ...
              {confirm && password !== confirm && (
                <p style={{ margin: '4px 0 0', fontSize: '0.72rem', color: '#f87171' }}>Passwords don't match</p>
              )}
              {confirm && password === confirm && confirm.length >= 6 && (
                <p style={{ margin: '4px 0 0', fontSize: '0.72rem', color: '#86efac' }}>✓ Passwords match</p>
              )}
            </div>
